          ...
          <transition-group name="fade">
            ...
            <div class="copy" v-bind:key="slides[slidePosition].id" >
              ...
              <div v-for="list in slides[slidePosition].fadeLists" v-bind:key="slides[slidePosition].id">
                ...
                <p v-for="item in list.items" v-bind:class="{bold: item.b, orange: item.o}">
              ...
              <ul v-for="list in slides[slidePosition].lists" v-bind:key="slides[slidePosition].id">
                ...
                <li class="listItem" v-for="item in list.items" v-bind:class="{bold: item.b, orange: item.o}">{{item.text}}</li>
              </ul>
            ...
            <div class="tourQuizText" v-if="slides[slidePosition].tourQuiz" v-bind:key="slides[slidePosition].id">
              ...
              <p v-if="slides[slidePosition].correct" class="feedback"><span>?</span>Correct</p>
              <p v-if="slides[slidePosition].correct === false" class="feedback"><span>X</span>Incorrect</p>
            </div>
            ...
            <ul v-for="tip in slides[slidePosition].tooltips" v-bind:class="{current: tip.current}" v-bind:key="slides[slidePosition].id">
      ...
      <div class="progNav" >
        ...
        <div v-if="notFirstSlide">
          ...
          <div v-if="moduleEnd" class="imgWrap next">
            <router-link v-on:click.native="moduleComplete(6, 7)" to='/module-7'><p>Next</p><img src="../assets/arrow-right-thick.svg" alt="Next"></router-link>
          </div>
...
import moduleSix from '../components/moduleSix.js'
import mixin from '../components/mixin.js'

const slideCount = moduleSix.length
...
export default {
  ...
  data () {
    return {
      slides: moduleSix,
      moduleTitle: 'Module 6 - <span>Additional Features</span>',
