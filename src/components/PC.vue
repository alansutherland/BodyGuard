      ...
      <div class="progNav" >
        ...
        <div v-if="notFirstSlide">
          ...
          <div v-if="moduleEnd" class="imgWrap next">
            <router-link v-on:click.native="modeComplete(2)" to='/module-2'><p>Next</p><img src="../assets/arrow-right-thick.svg" alt="Next"></router-link>
          </div>
