      ...
      <div class="progNav" >
        ...
        <div v-if="notFirstSlide">
          ...
          <div v-if="moduleEnd" class="imgWrap next">
            <router-link v-on:click.native="modeComplete(5)" to='/module-1'><p>Next</p><img src="../assets/arrow-right-thick.svg" alt="Next"></router-link>
          </div>
...
const slideCount = library.length
